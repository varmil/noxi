...
export default async function DashboardTicketsPreview() {
  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertTitle>下記はプレビュー表示です</AlertTitle>
        <AlertDescription>
          新規登録 /
          ログインを行うことで、あなたの応援チケットの保有状況や使用履歴の確認が可能になります。
        </AlertDescription>
      ...
      <Card>
        <CardHeader>
          <CardTitle>応援チケット（Preview）</CardTitle>
          <CardDescription>
