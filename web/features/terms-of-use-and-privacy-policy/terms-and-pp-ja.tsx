      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mt-4 space-y-4">
            ...
            <p>
              5.1
              ハイパーチャットは、タレント本人または所属事務所への投げ銭・寄付ではなく、VChartsが提供するコメント掲載機能の利用料です。お支払いいただいた金額がタレント本人に届くものではありません。
            </p>
            <p>
              5.2
            ...
            <ul className="ml-4">
              ...
              <li>・法令に違反する内容、または違反行為を助長する内容</li>
              <li>
                ・タレント本人・所属事務所・他のユーザーの権利を侵害する行為
              </li>
