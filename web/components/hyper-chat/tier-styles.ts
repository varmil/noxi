...
export const TIER_BG_COLORS: Record<TierValue, string> = {
  ...
  premium: 'bg-orange-300 dark:bg-orange-500',
  special: 'bg-red-600 dark:bg-red-700'
}
...
export const TIER_BORDER_COLORS: Record<TierValue, string> = {
  ...
  premium: 'border-orange-300 dark:border-orange-500',
  special: 'border-red-600 dark:border-red-700'
}
...
export const TIER_BORDER_LEFT_COLORS: Record<TierValue, string> = {
  ...
  premium: 'border-l-orange-400 dark:border-l-orange-400',
  special: 'border-l-red-700 dark:border-l-red-600'
}
...
export const TIER_TEXT_MUTED_COLORS: Record<TierValue, string> = {
  ...
  premium: 'text-orange-900 dark:text-gray-800',
  special: 'text-gray-50 dark:text-gray-300'
}
...
export const TIER_RING_COLORS: Record<TierValue, string> = {
  ...
  premium: 'ring-orange-500',
  special: 'ring-red-600'
}
